...
function send_transaction_details($email, $pin_no, $nepAmount, $amount, $receiverName, $paymentType, $senderName)
{
    ...
    try {
        ...
        $mail->Subject = 'Thank you for working via us - Nepal Money Express';
        $mail->MsgHTML(
            '
<html>
<body>
<div style="padding: 15px;
    ...
    Your order has been placed. Thank you for working via us. We will inform you once the money has been delivered to the receiver.<br><br>
    ...
    Please provide this pin code <b style="font-size: 30px;">' . $pin_no . '</b> to your receiver.
</div>
<br><br>
<div style="text-align: center">
